...
inline constexpr const char *kActionId = "KDEUninstall";
inline constexpr const char *kActionGroup = "Desktop Action KDEUninstall";
inline constexpr const char *kManagedKey = "X-KDE-Uninstall-Managed";
